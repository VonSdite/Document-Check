...
一个基于 Flask + SQLite 的文档智能门禁网站，支持用户上传 docx、pdf、txt、md、html、xlsx、xlsm、xls 文档，并通过用户自行配置的 OpenAI Chat Completions 兼容模型执行单文档规范性、易理解性、内容正确性、内容完整性检查，以及多文档对照、跨语种文档一致性和多模态图片检查。
